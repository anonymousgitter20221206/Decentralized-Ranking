...
const GasBlsFactory_1 = require("../types/ethers-contracts/GasBlsFactory");
const TestBlsFactory_1 = require("../types/ethers-contracts/TestBlsFactory");
const utils_1 = require("./utils");
const FACTORY_GAS_BLS = new GasBlsFactory_1.GasBlsFactory(provider_1.wallet);
...
describe('BLS', () => {
    ...
    it('map to point ft', async function () {
        ...
        chai_1.assert.equal(out1, utils_1.bigToHex(res[0]));
        chai_1.assert.equal(out2, utils_1.bigToHex(res[1]));
...
//# sourceMappingURL=bls_gas.test.js.map